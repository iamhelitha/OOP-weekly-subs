    ...
    public BicycleView() {
        btnAddBicycle.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Bicycle added successfully!","Success",2);
        ...
        btnBreak.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Break Applied!", "Success",2);
            }
        });
        btnSpeedUp.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Speed Up!","Success",2);
                lblCurrentSpeed.setText(bicycle.toString());
            }
        });
    }
